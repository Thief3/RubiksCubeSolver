...
pub fn r(rubiks: Rubiks) -> Rubiks {
    rotate_right_clockwise(rubiks)
}

/// Left Clockwise turn
pub fn l(rubiks: Rubiks) -> Rubiks {
    let mut my_rubiks = Rubiks {
        front: rubiks.back,
        right: rubiks.left,
        back: rubiks.front,
...
pub fn d(rubiks: Rubiks) -> Rubiks {
    let mut my_rubiks = Rubiks {
        front: rubiks.bottom,
        right: rotate_face_clockwise(rubiks.right),
        back: rubiks.top,
        left: rotate_face_anticlockwise(rubiks.left),
        top: rubiks.front,
        bottom: flip_vert(flip_horz(rubiks.back)),
    };
    my_rubiks = f(my_rubiks);
    my_rubiks = Rubiks {
        front: my_rubiks.top,
        right: rotate_face_anticlockwise(my_rubiks.right),
        back: flip_vert(flip_horz(my_rubiks.bottom)),
        left: rotate_face_clockwise(my_rubiks.left),
        top: (my_rubiks.back),
        bottom: my_rubiks.front,
    };

    my_rubiks
}

pub fn u(rubiks: Rubiks) -> Rubiks {
    let mut my_rubiks = Rubiks {
        front: rubiks.top,
        right: rotate_face_anticlockwise(rubiks.right),
        back: flip_vert(flip_horz(rubiks.bottom)),
        left: rotate_face_clockwise(rubiks.left),
        top: flip_vert(flip_horz(rubiks.back)),
        bottom: rubiks.front,
    };
    my_rubiks = f(my_rubiks);
    my_rubiks = Rubiks {
        front: my_rubiks.bottom,
        right: rotate_face_clockwise(my_rubiks.right),
        back: flip_vert(flip_horz(my_rubiks.top)),
        left: rotate_face_anticlockwise(my_rubiks.left),
        top: my_rubiks.front,
        bottom: flip_vert(flip_horz(my_rubiks.back)),
    };
...
mod tests {
    ...
    fn test_notation_u() {
        ...
        let test_rubiks = Rubiks {
            front: [0, 0, 0, 0, 0, 0, 1, 1, 1],
            right: [1, 1, 1, 1, 1, 1, 2, 2, 2],
            back: [2, 2, 2, 2, 2, 2, 3, 3, 3],
            left: [3, 3, 3, 3, 3, 3, 0, 0, 0],
    ...
    fn test_notation_u_two() {
        ...
        let test_rubiks = Rubiks {
            front: [0, 1, 2, 3, 4, 5, 15, 16, 17],
            right: [9, 10, 11, 12, 13, 14, 24, 25, 26],
            back: [18, 19, 20, 21, 22, 23, 33, 34, 35],
            left: [27, 28, 29, 30, 31, 32, 6, 7, 8],
